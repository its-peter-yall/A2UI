...
- [ ] **Phase 16: Schema Foundation & Backward Compatibility** - Extend TopicNode with complexity and quiz_count fields, ensuring existing courses still load
- [ ] **Phase 17: Quizzer Multi-Quiz Generation** - Generate QuizSets with difficulty gradients in a single batch LLM call
- [ ] **Phase 18: Planner Complexity Assignment** - Prompt engineering for AI-driven complexity rating and quiz count per topic
