      ...
      >
        ...
        >
          ...
          {revisionSummary.quizzes_total > 0 && (
            <div className="flex items-center justify-center gap-4 text-sm text-muted-foreground">
              <span data-testid="quizzes-passed">
                <span className="font-medium text-green-400">{revisionSummary.quizzes_passed}</span> passed
              </span>
              <span className="text-white/20">|</span>
              <span data-testid="quizzes-failed">
                <span className="font-medium text-red-400">{revisionSummary.quizzes_failed}</span> failed
              </span>
              <span className="text-white/20">|</span>
          ...
          {revisionSummary.time_spent_seconds !== null && (
            <p className="text-center text-xs text-muted-foreground" data-testid="time-spent">
          ...
          {comparison && (
            ...
            >
              ...
              <div className="flex items-center justify-between text-sm">
                ...
                <span className="font-medium text-foreground" data-testid="original-score">
                  {Math.round(comparison.original_quiz_score_percent)}%
                </span>
              </div>
              <div className="flex items-center justify-between text-sm">
                <span className="text-muted-foreground">Improvement:</span>
                <ImprovementBadge improvement={comparison.improvement_percent} />
              </div>
            </div>
          )}
