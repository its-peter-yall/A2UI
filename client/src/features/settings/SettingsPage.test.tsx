...
describe('SettingsPage', () => {
  ...
  it('renders the Settings title and subtitle', () => {
    ...
    expect(screen.getByText(/Configure system configurations, API credentials, and appearance preferences/i)).toBeInTheDocument();
  });
  ...
  it('renders the always-expanded AI credentials settings card directly', () => {
    ...
    expect(screen.queryByRole('button', { name: 'Configure AI Provider' })).not.toBeInTheDocument();
